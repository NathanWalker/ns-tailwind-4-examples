<page actionBarHidden="true">
    <gridLayout class="bg-black">
        ...
        <gridLayout class="align-bottom" columns="*,auto,auto,*">
            <image col={1} src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Svelte_Logo.svg/996px-Svelte_Logo.svg.png?20191219133350" class="size-18 mr-2"></image>
